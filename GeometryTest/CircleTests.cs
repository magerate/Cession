...
namespace GeometryTest
{
    ...
    public class CircleTests
    {
        ...
        public void IntersectsTest1 ()
        {
            ...
            Assert.NotNull (pp);
            PointHelper.AreEqual (pp.Item1, pp.Item2);
        ...
        public void IntersectsTest4 ()
        {
            Action test = () =>
            {
                ...
                var r1 = RandomHelper.NextDouble ();

                var p2 = PointHelper.CreateRandomIntPoint ();
                var r2 = RandomHelper.NextDouble ();
        ...
        public void IntersectsWithLineTest2 ()
        {
            Action test = () =>
            {
                var c1 = PointHelper.CreateRandomIntPoint ();
                var r1 = RandomHelper.NextDouble ();
        ...
        public void GetCenterTest2 ()
        {
            Action test = () =>
            {
                var p1 = PointHelper.CreateRandomIntPoint ();
                var p2 = PointHelper.CreateRandomIntPoint ();
                var p3 = PointHelper.CreateRandomIntPoint ();
                ...
                if (cp != null)
                {
                    ...
                    TestHelper.AlmostEqual (d1, d2, 4);
                    TestHelper.AlmostEqual (d1, d3, 4);
                    TestHelper.AlmostEqual (d2, d3, 4);
                }
            };
