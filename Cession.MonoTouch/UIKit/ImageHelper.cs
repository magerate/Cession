...
namespace Cession.UIKit
{
    public static class ImageHelper
    {
        ...
        public static UIImage Scale (this UIImage image, float maxSize)
        {
            ...
            var ratioX = GetSizeRatio ((float)image.Size.Width, maxSize);
            var ratioY = GetSizeRatio ((float)image.Size.Height, maxSize);
            ...
            var size = new CGSize (image.Size.Width * ratio, image.Size.Height * ratio);
        ...
        public static UIImage Crop (this UIImage image, CGRect bounds)
        {
