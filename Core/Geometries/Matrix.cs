...
namespace Cession.Geometries
{
	...
	public partial struct Matrix: IFormattable
	{
		...
		{
			Point2 newPoint = point;
			MultiplyPoint(ref newPoint.X, ref newPoint.Y);
			return newPoint;
		}
		...
		public void Transform(Point2[] points)
		{
			if (points != null)
			{
		...
		public Vector Transform(Vector vector)
		{
			...
			MultiplyVector(ref newVector.X, ref newVector.Y);
			return newVector;
		}
		...
		public void Transform(Vector[] vectors)
		{
			if (vectors != null)
			{
				...
				{
					MultiplyVector(ref vectors[i].X, ref vectors[i].Y);
				}
			}
		}
